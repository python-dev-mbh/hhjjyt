...
urlpatterns = [
    ...
    path('service-category/<int:category_id>/', views.ServiceCategoryRetrieveUpdateDestroyAPIView.as_view(), name='service-category-retrieve-update-destroy'),
    path('projects/', views.ProjectListCreateAPIView.as_view(), name='project-list-create'),
    path('projects/<int:project_id>/', views.ProjectRetrieveCreateAPIView.as_view(), name='project-detail'),
    ...
    path('course-type/<int:type_id>/', views.CourseTypeRetrieveUpdateDestroyAPIView.as_view(), name='course-type-retrieve-update-destroy'),
    path('courses/', views.CourseListCreateAPIView.as_view(), name='course-list-create'),
    path('courses/<int:type_id>/<int:course_id>/', views.CourseRetrieveUpdateDestroyAPIView.as_view(), name='course-retrieve-update-destroy'),
